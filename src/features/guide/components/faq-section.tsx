...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "Lorofy allows for incoming emergency calls, but leaving the app to check other apps will pause or wither your plant.",
  },
  {
    question: "How do I lock focus mode?",
    answer:
      "Turn on the Hard Lock settings in your focus settings pane. This prevents you from pausing the timer once started.",
  },
  {
    question: "Is my focus history synced across devices?",
    answer:
      "Yes, cloud sync is included for all users. You can review metrics on both Android and iOS devices.",
  },
  {
    question: "Can I customize the background soundtrack?",
    answer:
      "Yes! You can load customized background audio tracks and adjust duration fade-ins.",
  },
  {
    question: "Is Lorofy free to use?",
    answer:
      "Yes, Lorofy's core tools, focus timer, and basic plants are completely free. Upgrade to Premium for advanced stats.",
  },
  {
    question: "Can I share my plants with my friends?",
    answer:
      "Yes, you can export high-quality screenshots of your botanical assets or share your leaderboard links.",
  },
];
