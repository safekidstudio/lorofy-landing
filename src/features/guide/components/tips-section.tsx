...
const PRO_TIPS = [
  {
    ...
    description:
      "Keep your physical study desk organized and set your phone out of arm's reach.",
  },
  {
    title: "Hard Lock Focus Mode",
    description:
      "Enable hard lock settings to build self-discipline and minimize phone pickup impulses.",
  },
  {
    title: "Use the Ambient Sounds",
    description:
      "Turn on forest ambient loops to mask distracting background hums and chatter.",
  },
  {
    title: "Streaks Matter",
    description:
      "Growing just 1 plant a day keeps your streak multiplier active and boosts focus coin yields.",
  },
];
