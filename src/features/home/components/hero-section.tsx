    ...
    <Bounded className="bg-background" id="hero">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-20 items-center overflow-hidden">
        ...
        <div className="md:col-span-7">
          <ScrollAnimatedContainer type="slide" direction="left" delay={0.1} className="flex flex-col items-start text-left gap-6">
            {/* Badge */}
        ...
        <div className="md:col-span-5 w-full flex justify-center items-center">
          <ScrollAnimatedContainer type="slide" direction="right" delay={0.2} className="w-full">
