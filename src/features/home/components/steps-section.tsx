      ...
      <div className="flex flex-col items-center gap-16">
        ...
        >
          ...
          <Paragraph variant="section">
            No complicated settings. Open Lorofy, set a timer threshold, and
            ...
            <div className="flex flex-col items-center text-center gap-4 group">
              ...
              <div className="flex flex-col gap-2 max-w-sm">
                ...
                <Paragraph variant="card">
                  Decide on your task and set the customized focus session that
          ...
          >
            <div className="flex flex-col items-center text-center gap-4 group">
              ...
              <div className="flex flex-col gap-2 max-w-sm">
                ...
                <Paragraph variant="card">
                  Keep the app active. Leaving your focus session will pause or
                  halt your growth deficit.
                </Paragraph>
              </div>
            </div>
          </ScrollAnimatedContainer>
          ...
          >
            <div className="flex flex-col items-center text-center gap-4 group">
              ...
              <div className="flex flex-col gap-2 max-w-sm">
                ...
                <Paragraph variant="card">
                  Complete the timer to add a gorgeous new plant to your private
                  garden collection.
                </Paragraph>
              </div>
            </div>
